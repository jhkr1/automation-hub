...
| Namuwiki Trends | 최신 Top 10, 선택 검색어 순위 이력, 검색어 통계 |
| Operations | Snapshot·로그 파일 메타데이터·Alembic·런타임 상태 |
...
아직 구현하지 않았습니다. 이 Dashboard는 로컬 Streamlit 화면이며, 외부 공개 전에는 MySQL read-only
계정을 사용해야 합니다.
